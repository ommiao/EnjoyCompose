package com.example.enjoycompose.ui.theme
...
@Composable
fun EnjoyComposeTheme(theme: EnjoyComposeTheme.Theme = EnjoyComposeTheme.Theme.Light, content: @Composable () -> Unit) {
    val targetColors = when (theme) {
        EnjoyComposeTheme.Theme.Light -> LightColorPalette
        EnjoyComposeTheme.Theme.Dark -> DarkColorPalette
        EnjoyComposeTheme.Theme.NewYear -> NewYearColorPalette
    }
